    ...
    <header className="relative">
      ...
      <div className="bg-gold text-gray-900 py-2 px-4 text-center font-medium">
        <div className="flex items-center justify-center gap-2">
          ...
          <span>Our official website is sbmforexacademy.com – Beware of fake!</span>
        </div>
      </div>
        ...
        <div className="container-custom py-4">
          <div className="flex items-center justify-between">
            ...
            <Link to="/" className="flex items-center">
              ...
              <span className="ml-2 text-xl font-bold">SBM Forex</span>
            </Link>
              ...
              {links.map((link) => (
                <Link
                  ...
                  className={`font-medium hover:text-gold transition-colors ${
                    pathname === link.path ? 'text-gold' : 'text-gray-200'
                  }`}
                >
                  {link.name}
                </Link>
