        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
          ...
          >
            ...
            <h1 className="heading-xl mb-6">
              Master the <span className="gradient-text">Forex Market</span> With Expert Guidance
            </h1>
            
            <p className="text-gray-300 text-lg mb-8 max-w-lg">
              Join thousands of successful traders who have transformed their trading journey with SBM Forex Academy's proven strategies and expert mentorship.
            </p>
            ...
            <div className="mt-8 flex items-center gap-6">
              ...
              <div className="text-sm">
                <p className="text-gray-300">Joined by <span className="text-gold font-semibold">300,000+</span> traders</p>
            ...
            <div className="relative">
              <div className="card-glass p-8 relative z-10">
                <div className="bg-dark-lighter p-4 rounded-lg mb-6">
                  <h3 className="text-lg font-semibold text-gold mb-2">Latest Signal Success</h3>
                  <div className="space-y-3">
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-400">EUR/USD</span>
                      <span className="text-emerald font-medium">+125 pips</span>
                    </div>
                    <div className="flex justify-between text-sm">
                      <span className="text-gray-400">GBP/JPY</span>
                      <span className="text-emerald font-medium">+213 pips</span>
                    </div>
                    <div className="flex justify-between text-sm">
                ...
                <div className="bg-gradient-to-r from-gold/20 to-gold/10 p-4 rounded-lg">
                  <h3 className="font-semibold mb-3">Ready to transform your trading?</h3>
                  <p className="text-sm text-gray-300 mb-4">
                    Get started today with our premium forex education and signals.
                  </p>
                  <Link to="/register" className="text-gold flex items-center text-sm font-medium">
                ...
                <div className="absolute -top-4 -left-4 bg-dark-lighter py-2 px-4 rounded-lg shadow-lg border border-emerald/30 animate-float" style={{ animationDelay: '1s' }}>
