        ...
        <div className="card-glass border border-gray-700/30 p-8 md:p-12 text-center max-w-4xl mx-auto">
          <AnimatedSection>
            ...
            <p className="text-gray-300 text-lg mb-8 max-w-2xl mx-auto">
              Join thousands of traders who have elevated their forex trading with SBM Forex Academy's 
              expert mentorship, accurate signals, and professional account management.
            </p>
            ...
            <div className="mt-8 text-sm text-gray-400">
              Start your trading journey today – No credit card required for basic membership
            </div>
          </AnimatedSection>
        </div>
      </div>
