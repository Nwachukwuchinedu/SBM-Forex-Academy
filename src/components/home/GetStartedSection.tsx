            ...
            <div className="card-glass p-8 border border-gray-700/50 relative">
              ...
              <div className="space-y-4">
                <div className="flex items-start gap-3">
                  ...
                  <p className="text-gray-300">Free consultation with a trading expert</p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="mt-1 text-emerald">
                    <Check className="h-5 w-5" />
                  </div>
                  <p className="text-gray-300">Personalized service recommendation</p>
                </div>
                <div className="flex items-start gap-3">
                  <div className="mt-1 text-emerald">
                    <Check className="h-5 w-5" />
                  </div>
                  <p className="text-gray-300">24/7 customer support for all members</p>
                </div>
              </div>
