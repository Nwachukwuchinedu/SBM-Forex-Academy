      ...
      <div className="container-custom relative z-10">
        <AnimatedSection className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="heading-lg mb-6">
            Comprehensive <span className="emerald-gradient-text">Forex Solutions</span>
          </h2>
          <p className="text-gray-300">
            Whether you're looking to learn, receive signals, or have your account professionally managed, 
            we offer tailored services to meet your trading needs.
          </p>
        </AnimatedSection>
