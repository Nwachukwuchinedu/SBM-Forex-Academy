          ...
          <AnimatedSection>
            <div className="card-glass p-8 border border-gray-700/30">
              <div className="text-center mb-8">
                ...
                <p className="text-gray-400">Sign in to access your SBM Forex Academy account</p>
              </div>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-dark-lighter border border-gray-700 rounded-md py-2 px-3 text-white focus:outline-none focus:ring-2 focus:ring-gold/50"
                    required
                  />
                </div>
                ...
                <button
                  type="submit"
                  className="w-full bg-gradient-to-r from-gold to-amber-500 text-gray-900 py-3 px-4 rounded-md font-medium hover:shadow-glow transition-all duration-300"
                >
                  Sign In
                </button>
              </form>
              ...
              <div className="mt-8 pt-6 border-t border-gray-700 text-center">
                ...
                <Link
                  to="/register"
                  className="w-full inline-block bg-dark-lighter border border-gold text-gold py-2 px-4 rounded-md font-medium hover:bg-gold hover:text-gray-900 transition-colors"
                >
                  Create Account
                </Link>
              </div>
